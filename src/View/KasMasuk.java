...
public class KasMasuk extends javax.swing.JFrame {
    Connection con;
    Statement stm;
    ResultSet rs;
    ...
    public void tambahData() {
         try {
            ...
            String query = "INSERT INTO tb_masuk (tanggal_masuk, no_nota, terima_dari, jumlah) "
                    + "VALUES ('"+ tanggal+
                               "', '"+ tNota.getText()+
                               "', '"+ tTerima.getText()+
                               "', '"+ tTotal.getText()+
    ...
    public void showData(){
        ...
        String sql_data = "Select * from tb_masuk";
        try {
            Connection con = connectionHelper.getConnection();
    ...
    public void updateData() {
        ...
        String tanggal = String.valueOf(fm.format(tDate.getDate()));
         try {
            ...
            String query = "UPDATE tb_masuk set tanggal_masuk = '"+tanggal+
                    "',no_nota = '"+tNota.getText()+
                    "',terima_dari = '"+tTerima.getText()+
                    "',jumlah = '"+tTotal.getText()+
                    "'WHERE id_masuk ='"+ tId.getText()+"'";
            stm.executeUpdate(query);
        ...
        if (selectedRow == -1) {
            ...
            if (option == JOptionPane.YES_OPTION) {
                try {
                    Connection con = connectionHelper.getConnection();
                    Statement stm = con.createStatement();
                    appModel kasMasuk = showData.get(selectedRow);
                    stm.executeUpdate("DELETE FROM tb_masuk WHERE id_masuk = " + kasMasuk.getId_masuk());
                    showData();
                } catch (Exception e) {
                    System.out.println("Error:" + e.getMessage());
                }
    ...
    private void initComponents() {
        ...
        Background.setIcon(new javax.swing.ImageIcon(getClass().getResource("/assets/mockup kasmasuk.JPG"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(KasMasuk.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
